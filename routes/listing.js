...
router
  ...
  // Update Route
    .put(upload.single("listing[image]"),isOwner,
    isLogged, listingControllers.updateListing)
  //delete route
  .delete(isLogged,isOwner, wrapAsync(listingControllers.destroyListing));

//edit route
router.get("/:id/edit", isLogged,isOwner, wrapAsync(listingControllers.editListing));
